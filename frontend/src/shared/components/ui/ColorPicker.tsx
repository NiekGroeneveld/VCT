    ...
    <div className={`space-y-3 ${className}`}>
      ...
      <div className="flex items-center gap-3">
        ...
        <input
          ...
          placeholder="#3B82F6"
          className="flex-1 px-3 py-2 border bg-gray-200 border-gray-700 text-gray-700 rounded-md focus:outline-none focus:ring-2 focus:ring-white focus:border-transparent font-mono text-sm uppercase"
        />
      </div>
      
      {/* Color grid */}
      <div className="grid grid-cols-12 gap-1 p-2 bg-gray-200 rounded-lg max-h-32 overflow-y-auto">
